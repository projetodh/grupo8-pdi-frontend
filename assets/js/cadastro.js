...
// amanha eu preciso resolver esse problema de execução da funcao submitForm
// resolver o problema da class control error e success (porque elas nao estao chamando)
// preciso validar outros campos
...
//    new Number(value)
   ...
   const passwordValue = password.value.trim()
    ...
    if (passwordValue === '') {
        ...
        alertError(password, 'Sua senha precisa de no mínimo 8 caracteres')
